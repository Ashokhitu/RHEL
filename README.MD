...
sha1sum VMware-Workstation-Full-16.1.0-17198959.x86_64.bundle #确认是9e8268ee8d06470e839507edff30d97de55aa63c
sh VMware-Workstation-Full-16.1.0-17198959.x86_64.bundle --console --ignore-errors --set-setting vmware-workstation serialNumber ZF3R0-FHED2-M80TY-8QYGC-NPKYF
```
...
```
md5sum anyconnect-linux64-4.9.05042-predeploy-k9.tar.gz #确认是39e4a7857b147ad0058bd05f04e7144a
